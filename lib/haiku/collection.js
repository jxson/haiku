...
_.extend(Collection.prototype, {
  ...
  buildIndex: function() {
    ...
    _.each(pages, function(page){
      // problem with wrapping templates is that it wont get built and we
      // can't key off template or layout urls
      // NOTE: this check could be moved into the page.name() function...
