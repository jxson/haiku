...
_.extend(Site.prototype, {
  ...
  build: function() {
    ...
    console.log('directories'.magenta, directories);
    // console.log('site'.magenta, build);
    ...
    mkdirp(directories.build, 0755, function(err){
      ...
      _.each(site.content.index(), function(page){
        console.log('page: '.inverse.yellow , page.url().yellow);
        console.log('buildpath: '.inverse.yellow , page.buildPath().yellow);
