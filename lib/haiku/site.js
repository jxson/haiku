...
var Site = function(options) {
  ...
  this.options = _.defaults(options, {
    ...
    buildDir: 'build',
    // `options.contentDir` is the root relative path to the directory where
    // the Haiku content is, files in the 'options.contentDir' will be read
    // and converted by Haiku into your site's files. All content in this
