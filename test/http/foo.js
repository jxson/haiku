...
describe('haiku.handler(req, res, opts)', function(){
  it('exists', function(){
    assert.isFunction(haiku.handler)
  })

  it('returns a response handler', function(){
    var server = http.createServer(function(req, res){
      res.haiku = haiku.handler(req, res, { root: blog })
...
// var server = require('../support/handler-server')
//   , haiku = require('../../lib')
//   , assert = require('../support/assert')
//   , request = require('supertest')
  ...
  # for options, head, get

  * renders content as html
  * 200 ok
  * has an etag
  * does not override headers

  responds 304 with appropriate last-modififed
